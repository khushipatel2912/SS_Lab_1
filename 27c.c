...
int main() {
    char *environment[] = { "PATH=/bin", NULL };
    printf("Executing ls -Rl using execle:\n");
    if (execle("/bin/ls", "ls", "-Rl", NULL, environment) == -1) {
...
Output:
khushi@khushi-HP-Pavilion-Laptop-14-dv0xxx:~/my-repo$ gcc 27c.c -o 27c
khushi@khushi-HP-Pavilion-Laptop-14-dv0xxx:~/my-repo$ ./27c
...
-rw-rw-r-- 1 khushi khushi   455 Aug 31 23:25 27c.c
